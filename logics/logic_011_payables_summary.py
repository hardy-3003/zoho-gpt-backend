...
ID: L-011
Tags: []
Required Inputs: schema://payables_summary.input.v1
Outputs: schema://payables_summary.output.v1
Assumptions: 
...
def handle_impl(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        pack = log_with_deltas_and_anomalies(
            "L-011", payload, out.get("result") or {}, prov
        )
        if pack.get("alerts"):
