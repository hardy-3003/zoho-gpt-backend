...
def handle_impl(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        journals_url = f"{api_domain}/books/v3/journals?accounts=tds&date_start={start_date}&date_end={end_date}&organization_id={org_id}"
