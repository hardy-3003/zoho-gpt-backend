...
ID: L-051
Tags: []
Required Inputs: schema://interest_paid_summary.input.v1
Outputs: schema://interest_paid_summary.output.v1
Assumptions:
...
LOGIC_META = {
    "id": "L-051",
    "title": "Interest Paid Summary",
    "tags": ["interest", "loan", "expense"],
}


def _validate_interest_paid(result: Dict[str, Any]) -> List[str]:
    alerts: List[str] = []
...
def handle_impl(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    alerts = _validate_interest_paid(result)
