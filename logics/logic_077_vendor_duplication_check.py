...
"""
Title: Vendor Duplication Check
ID: L-077
Tags: []
Required Inputs: schema://vendor_duplication_check.input.v1
Outputs: schema://vendor_duplication_check.output.v1
Assumptions: 
...
LOGIC_META = {
    "id": "L-077",
    "title": "Vendor Duplication Check",
    "tags": ["vendor", "duplicate", "master"],
}


def _validate_vendor_dupes(result: Dict[str, Any]) -> List[str]:
    alerts: List[str] = []
...
def handle_impl(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    alerts = _validate_vendor_dupes(result)
