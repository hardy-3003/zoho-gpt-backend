...
"""
Title: Advance Paid Adjustment
ID: L-091
Tags: []
Required Inputs: schema://advance_paid_adjustment.input.v1
Outputs: schema://advance_paid_adjustment.output.v1
Assumptions: 
...
LOGIC_META = {
    "id": "L-091",
    "title": "Advance Paid Adjustment",
    "tags": ["advance", "paid", "ap"],
}


def _validate_adv_paid(result: Dict[str, Any]) -> List[str]:
    alerts: List[str] = []
...
def handle_impl(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    alerts = _validate_adv_paid(result)
