...
ID: L-094
Tags: []
Required Inputs: schema://business_health_score.input.v1
Outputs: schema://business_health_score.output.v1
Assumptions: 
...
LOGIC_META = {
    "id": "L-094",
    "title": "Business Health Score",
    "tags": ["health", "kpi", "score"],
}


def _validate_health(result: Dict[str, Any]) -> List[str]:
    alerts: List[str] = []
...
def handle_impl(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    alerts = _validate_health(result)
