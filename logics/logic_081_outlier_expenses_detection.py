...
LOGIC_META = {
    "id": "L-081",
    "title": "Outlier Expenses",
    "tags": ["outlier", "expenses", "alerts"],
}


def _validate_outliers(result: Dict[str, Any]) -> List[str]:
    alerts: List[str] = []
    outliers = result.get("outliers", [])
    for o in outliers:
        z = float(o.get("zscore", 0.0) or 0.0)
...
def handle(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    alerts = _validate_outliers(result)
