"""
Test for Outlier Expenses (Logic L-081).

This test verifies the basic functionality and contract compliance of the Outlier Expenses logic.
"""

import pytest
from logics.logic_081_outlier_expenses_detection import handle, LOGIC_META


class TestLogic081:
    """Test suite for Outlier Expenses logic."""
    ...
    def test_logic_meta_structure(self):
        ...
        assert LOGIC_META["id"] == "L-081"
        assert LOGIC_META["title"] == "Outlier Expenses"
