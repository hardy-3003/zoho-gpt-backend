"""
Test for Monthly Expense Trend (Logic L-033).

This test verifies the basic functionality and contract compliance of the Monthly Expense Trend logic.
"""

import pytest
from logics.logic_033_monthly_expense_trend import handle, LOGIC_META
